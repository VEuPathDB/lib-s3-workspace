...
interface S3Workspace {
  ...
  suspend fun touch(path: String): WorkspaceFile
   ...
   */
  @Throws(NullPointerException::class, IllegalArgumentException::class, S34KError::class)
  suspend fun write(path: String, stream: InputStream): WorkspaceFile
   ...
   */
  @Throws(NullPointerException::class, IllegalArgumentException::class, S34KError::class)
  suspend /*operator*/ fun get(path: String): WorkspaceFile?
  ...
  suspend fun copy(from: File, to: String): WorkspaceFile
  ...
  suspend fun copy(from: String, to: File)
   ...
   */
  @Throws(S34KError::class)
  suspend fun files(): List<WorkspaceFile>
  ...
  suspend /*operator*/ fun contains(path: String): Boolean
   ...
   */
  @Throws(NullPointerException::class, S34KError::class)
  suspend fun hasSubWorkspace(id: HashID): Boolean
   ...
   */
  @Throws(NullPointerException::class, S34KError::class)
  suspend fun openSubWorkspace(id: HashID): SubS3Workspace?
  ...
  suspend fun createSubWorkspace(id: HashID): SubS3Workspace
}